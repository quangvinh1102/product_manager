<div class="content-wrapper p-5 d-flex justify-content-center align-items-center">
    <div class="card " style="width: 80rem;">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title">Danh sách sản phẩm</h3>
            <a href="<?= _WEB_ROOT; ?>/dashboard/create" class="btn btn-primary">Thêm sản phẩm</a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <table id="basic-datatable" class="table" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $row["price"]; ?></td>
                        <td>
                            <a href="<?= _WEB_ROOT; ?>/dashboard/update/<?= $row["id"]; ?>"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a class="btn btn-primary" data-mdb-ripple-init
                                                href="<?= _WEB_ROOT; ?>/dashboard/delete/<?= $row["id"]; ?>"
