<nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarContent">
            <ul class="navbar-nav">
                <li class="nav-item mx-3">
                    <a class="nav-link text-primary" aria-current="page" href="<?= _WEB_ROOT; ?>/dashboard/index">Trang
                        chủ</a>
                </li>
                <?php if(isset($_SESSION["login"]) && $_SESSION["login"]["role"] == 0) { ?>
                <li class="nav-item mx-3">
        ...
        <div class="d-flex align-items-center">
            <?php if(isset($_SESSION["login"]) && $_SESSION["login"]["role"] != 0) { ?>
            <a href="<?= _WEB_ROOT; ?>/product/cart" class="btn btn-outline-danger mx-2 rounded-pill">
            <i class="fa-solid fa-cart-shopping"></i> Giỏ Hàng
            </a>
            ...
            <a href="<?= _WEB_ROOT; ?>/user/login" class="btn btn-primary mx-2 rounded-pill">
                <i class="fas fa-sign-in-alt"></i> Đăng nhập / Đăng ký
            </a>
            <?php } ?>
        </div>
    </div>
